...
public:
    ...
    virtual void OnError(const std::string& exception);
    ...
    //
    virtual void OnFrameBufferUpdate(const CFrameBuffer *pFrameBuffer, const CRect *pUpdateRect);
...
using CCoreEventsAdapterPtr = std::shared_ptr<CCoreEventsAdapter>;
